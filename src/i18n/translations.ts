...
export const translations = {
  TR: {
    ...
    'Fresh Homemade': 'Taze Yapım',
    'Homemade Iced Tea': 'Ev Yapımı Soğuk Çay',
    'Kaffeespezialitäten': 'Kahve Çeşitleri',
    'Säfte': 'Meyve Suları',
    'Shakes': 'Shakeler',
    'Signature Blends': 'İmza Harmanlar',
  ...
  RU: {
    ...
    'Fresh Homemade': 'Свежеприготовленное',
    ...
    'Smoothies': 'Смузи',
    'Sommer-Specials': 'Летние Спецпредложения',
    'Teas': 'Чаи',
