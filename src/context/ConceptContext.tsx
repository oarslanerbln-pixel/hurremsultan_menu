...
export type UIConcept = 'neo-classic' | 'brutalist' | 'skeuomorphic' | 'avant-garde' | 'cyber-gold' | 'ottoman-palace' | 'monolithic-matte';
...
const getInitialConcept = (): UIConcept => {
  if (typeof window !== 'undefined') {
    ...
    if (saved && ['neo-classic', 'brutalist', 'skeuomorphic', 'avant-garde', 'cyber-gold', 'ottoman-palace', 'monolithic-matte'].includes(saved)) {
      return saved;
    }
  }
  return 'neo-classic';
